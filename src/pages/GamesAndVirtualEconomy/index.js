            ...
            <div className="border-t border-transparent">
                ...
                <div className="relative border-t border-transparent">
                    ...
                    <div className="relative ml-3-2 mt-7-2 lg:absolute lg:z-10 lg:flex lg:flex-col lg:justify-center lg:h-full lg:items-start lg:left-5-6 lg:top-0-1 lg:mt-auto ">
                        <div className="text-white text-2-0 leading-point-114  w-20-1 font-black title-shadow-game lg:w-60-8 lg:text-4-0">
                ...
                <div className="">
                    <div className="relative lg:flex lg:flex-col lg:items-center lg:justify-start">
                        <div className="absolute top-0-1 -z-10 lg:hidden">
                            <img src="/images/mobile/game-module-bg.png" ></img>
                        </div>
                        <div className="hidden absolute top-0-1 -z-10 lg:block">
                            <img src="/images/pc/game-module-bg.png" ></img>
                        </div>
                        <div className="w-full flex flex-col justify-start items-center">
                            <div className="text-word-gray text-3-0 font-black text-center w-21-2 mt-1-4 mb-2-9 lg:w-43-3 lg:py-1-0">
                        ...
                        <div className="flex flex-col justify-start items-center">
                            <div className="flex flex-col justify-start items-center  lg:w-76-3 lg:px-4-4  lg:flex-row lg:rounded-2xl lg:mb-3-8 box-shadow-green">
                                ...
                                <div className="w-22-9 text-1-5 text-word-gray font-bold leading-point-126 mb-2-7 lg:w-60-6 lg:ml-6-9 lg:mb-0-1">
                        ...
                        <div className="w-full flex flex-col justify-start items-center">
                            <div className="text-word-gray text-3-0 font-black text-left w-22-9 mt-1-4 mb-2-9  lg:w-43-3 ">
                        ...
                        <div className="flex flex-col justify-start items-center lg:flex-row lg:w-84-9 lg:justify-between lg:items-start">
                            <div className="flex flex-col justify-start items-center w-20-8 py-2-7 box-shadow-green rounded-2xl text-word-gray relative mb-3-0 lg:w-26-9 lg:py-2-3 ">
                                ...
                                <div className="text-2-3 mb-3-9 font-bold lg:h-5-6 lg:w-21-4 ">Stable Value</div>
                                <div className="w-10-6 mb-3-0 h-10-6 ">
                                    <img className="" src="/images/mobile/stable-icon.png" alt=""></img>
                                </div>
                            ...
                            <div className="flex flex-col justify-start items-center w-20-8 py-2-7 box-shadow-green rounded-2xl text-word-gray relative mb-3-0 lg:w-26-9 lg:py-2-3 ">
                                ...
                                <div className="text-2-3 mb-3-9 font-bold lg:h-5-6 lg:w-21-4 ">Transaction <br></br>Eficiency</div>
                                <div className="w-10-6 mb-3-0 h-10-6 ">
                                    <img className="" src="/images/mobile/transaciton-icon.png" alt=""></img>
                                </div>
                            ...
                            <div className="flex flex-col justify-start items-center w-20-8 py-2-7 box-shadow-green rounded-2xl text-word-gray relative mb-3-0 lg:w-26-9 lg:py-2-3 ">
                                ...
                                <div className="text-2-3 mb-3-9 font-bold lg:h-5-6 lg:w-21-4 ">Global Market  <br></br>Integration</div>
                                <div className="w-10-6 mb-3-0 h-10-6 ">
                                    <img className="" src="/images/mobile/global-icon.png" alt=""></img>
                                </div>
                                <div className="w-16-6 font-bold text-0-9 leading-point-126 lg:w-22-6  lg:h-6-4">Stablecoins can achieve global market integration in the in-game virtual economy, provide players with a unified currency system, promote transactions and interactions among global players, and promote the global development of the virtual economy.</div>
                            </div>
                        </div>
                    </div>

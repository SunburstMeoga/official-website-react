    ...
    return (
        <div>
            ...
            <div className="hidden md:block">
                <div className="w-full flex flex-col items-center justify-start">
                    <div className="text-word-gray text-4xl font-bold text-center mb-10">
                        Contract Us
                    </div>
                            ...
                            {inforList.map((item, index) => {
                                return (
                                    <div key={index}>
                                        ...
                                        <div className="w-full border-b border-zinc-400 h-10 flex justify-center items-center mb-2">
                                            <input className="h-10 bg-transparent w-full"></input>
                                        </div>
                                    </div>
                                )
